...
public:
    static void project(Grid& g, double dt, Solver& solver, int max_iter, double tol);
    ...
    static void recoverStaticPressure(Grid& g, Solver& solver, int max_iter, double tol);
};
