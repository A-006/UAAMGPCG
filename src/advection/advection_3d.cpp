...
double trilinear(const Field& f, double fi, double fj, double fk, int sx, int sy, int sz,
                 Idx flat) {
...
void AdvectionScheme3D::backtrace(const Grid3D& g, double x, double y, double z, double dt,
