...
void ChorinSimulator::run() {
    ...
    // ── Time-march, dumping a VTK frame every frame_skip steps ──
    const int nsteps = static_cast<int>(cfg_.t_end / cfg_.dt);
